...
//     initialValues: {
//       hoTen: accountInfo && accountInfo.hoTen ? accountInfo.hoTen : "",
//       email: accountInfo && accountInfo.email ? accountInfo.email : "",
//       soDT: accountInfo && accountInfo.soDT ? accountInfo.soDT : "",
//       taiKhoan: accountInfo && accountInfo.taiKhoan ? accountInfo.taiKhoan : "",
//       matKhau: accountInfo && accountInfo.matKhau ? accountInfo.matKhau : "",
//       maNhom: accountInfo && accountInfo.maNhom ? accountInfo.maNhom : "",
//       maLoaiNguoiDung:
//         accountInfo && accountInfo.maLoaiNguoiDung ? accountInfo.maLoaiNguoiDung : "",
//     },
//     onSubmit: (values) => {
//       updateUser({
//         ...values,
...
//             </form>
//           </div>
//           <div className="w-full mx-auto lg:w-3/5 sm:w-4/5">{/* <Tabs items={items} /> */}</div>
//         </div>
//       </div>
//     </div>
//   );
...
const Profile = () => {
  ...
  const formik = useFormik({
    initialValues: {
      hoTen: accountInfo ? accountInfo.hoTen : "",
      email: accountInfo ? accountInfo.email : "",
      soDT: accountInfo ? accountInfo.soDT : "",
      taiKhoan: accountInfo ? accountInfo.taiKhoan : "",
      matKhau: accountInfo ? accountInfo.matKhau : "",
      maNhom: accountInfo ? accountInfo.maNhom : "",
      maLoaiNguoiDung: accountInfo ? accountInfo.maLoaiNguoiDung : "",
    },
    onSubmit: (values) => {
      updateUser({
        ...values,
          ...
          <div className="w-full mx-auto lg:w-2/5 sm:w-4/5">
            ...
            >
              ...
              <div className="flex items-center justify-between py-3 my-5 border-b-2">
                ...
                {account && <div>{account.taiKhoan}</div>}
              </div>
              ...
              <div className="flex items-center justify-between py-3 my-5 border-b-2">
                <div className="font-medium">Loại người dùng</div>
                <div className="text-right">
                  {account && account.maLoaiNguoiDung === "HV" ? "Học viên" : "Giáo vụ"}
                </div>
              </div>
              <div className="flex items-center justify-between py-3 mt-5 mb-10 border-b-2">
                <div className="font-medium">Mã nhóm</div>
                <div className="uppercase">{account && account.maNhom}</div>
              </div>
              <div className="text-center">
                {card ? (
                  <button className="px-3 py-2 text-white duration-300 bg-orange-400 rounded-lg hover:bg-orange-500 hover:scale-90">
